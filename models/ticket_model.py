...
class TicketModel(AbstractModel):
    ...
    def create_ticket(self, attributes):
        logger.info("########## {} create_ticket ##########".format(self.__class__.__name__))
        logger.info("attributes: {}".format(attributes))
        return self.insert(attributes)

    def get_ticket(self, ticket_id):
        logger.info("########## {} get_ticket ##########".format(self.__class__.__name__))
        logger.info("ticket_id: {}".format(ticket_id))
        return self.get(ticket_id)

    def delete_ticket(self, ticket_id):
        logger.info("########## {} delete_ticket ##########".format(self.__class__.__name__))
        logger.info("ticket_id: {}".format(ticket_id))
        return self.delete(ticket_id)

    def update_ticket(self, ticket_id, updated_attributes):
        logger.info("########## {} update_ticket ##########".format(self.__class__.__name__))
        logger.info("updated_attributes: {}".format(updated_attributes))
        logger.info("ticket_id: {}".format(ticket_id))
        return self.update(ticket_id, updated_attributes)

    def get_total_by_event(self, event_id):
    ...
    def get_total_by_ticket_type(self, ticket_type_id):
